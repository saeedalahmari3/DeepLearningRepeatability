...
def trainModel(path2Data,seed,iterationNum,GPU ,mode = 'train', nb_epoch = 20, batch_size = 16, img_width = 400,img_hight= 400, ch = 1,saveModelOption='last'):
    ...
    if not os.path.exists(os.path.join(expPath,'pytorch_exp_May2021_saveEveryEpochModel_singlePrecision_100Epochs')):
        os.makedirs(os.path.join(expPath,'pytorch_exp_May2021_saveEveryEpochModel_singlePrecision_100Epochs'))
    taskPath = os.path.join(expPath,'pytorch_exp_May2021_saveEveryEpochModel_singlePrecision_100Epochs')
